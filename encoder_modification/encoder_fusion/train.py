...
from model import FusionSpeaker, hybrid_loss
...
if WANDB_AVAILABLE:
    wandb.init(
        project="fusion-speaker-diarization",
        config={
            "d_model": D_MODEL,
            "n_heads": N_HEADS,
            "n_layers": N_LAYERS,
...
train_loader = make_loader(MANIFESTS / "train_fusion.json", shuffle=True)
...
print(f"FusionSpeaker: {n_params:,} params, input_dim={input_dim}")
